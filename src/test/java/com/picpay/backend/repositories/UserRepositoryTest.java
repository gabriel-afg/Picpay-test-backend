...
class UserRepositoryTest {
    ...
    void findByDocumentCase1(){
        ...
        UserDTO data = new UserDTO("Gabriel", "Teste",document, new BigDecimal(10), "test@gmail.com", "44444", UserType.COMMON);
    ...
    private User createUser(UserDTO data){
        ...
        this.entityManager.persist(newUser); //passar para o bd de testes
        return newUser;
    }
}